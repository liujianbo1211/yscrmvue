...
export const isLeave = [
    {'value_no': '0', 'value_name': '在职'},
    {'value_no': '1', 'value_name': '离职'},
]
export const shop_type = [
    {'value_no': '1', 'value_name': '销售'},
    {'value_no': '2', 'value_name': '采购'},
]
export const pay_type = [
    {'value_no': '1', 'value_name': '未支付'},
    {'value_no': '2', 'value_name': '未结算清'},
    {'value_no': '3', 'value_name': '已支付'},
]
